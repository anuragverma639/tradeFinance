        ...
        <div>
            <Navbar inverse >
                <Navbar.Header>
                    ...
                    <a href="#">CONSENSUS CHAIN (BANKS PANEL) </a>
              </LinkContainer>
                    </Navbar.Brand>
                    <Navbar.Toggle />
                </Navbar.Header>
                <Navbar.Collapse>
                    <Nav pullRight>
                        ...
                        <LinkContainer to="#">
                            <NavItem eventKey={2}  onClick={props.openCreateLOC_Modal}>CREATE LETTER OF CREDIT</NavItem>
