...
let Web3
let quotationList
class Notification_port extends Component {
    constructor(props) {
        super(props);
        this.state = {
            quotation:[],
    ...
    approveButtonFormatter(cell, row, enumObject, rowIndex) {
                ...
                //console.log(id);
                let url = `/portAuthorityPanel/ApproveQuotation/${id}`;
    ...
    render() {
        return (
            <div className="container-fluid">
                ...
                <h2>Notifications</h2>
                <LinkContainer  to="/portAuthorityPanel" >
...
export default Notification_port;